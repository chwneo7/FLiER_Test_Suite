...
# argdict["-write_file"] = "ieee57subs_4_13_34.txt"
# args = [NAME] + list(chain(*argdict.iteritems()))
# FLiER_Substation_Test.main(args)

# argdict["-pmus"] = "34"
# argdict["-write_file"] = "ieee57subs_35.txt"
# args = [NAME] + list(chain(*argdict.iteritems()))
# FLiER_Substation_Test.main(args)

# argdict["-pmus"] = "All,57"
# argdict["-write_file"] = "ieee57subs_All.txt"
# args = [NAME] + list(chain(*argdict.iteritems()))
# FLiER_Substation_Test.main(args)

# argdict["-pmus"] = "3,12,33"
# argdict["-write_file"] = "ieee57subs_4_13_34_noise0017.txt"
# argdict["-noise"] = "0.0017"
# args = [NAME] + list(chain(*argdict.iteritems()))
# FLiER_Substation_Test.main(args)

# argdict["-pmus"] = "34"
# argdict["-write_file"] = "ieee57subs_35_noise0017.txt"
# args = [NAME] + list(chain(*argdict.iteritems()))
# FLiER_Substation_Test.main(args)

# argdict["-pmus"] = "All,57"
# argdict["-write_file"] = "ieee57subs_All_noise0017.txt"
# args = [NAME] + list(chain(*argdict.iteritems()))
# FLiER_Substation_Test.main(args)
...
argdict["-pmus"] = ("1127,961,2287,512,1496,1423,470,1804,515,207,1736,1525," + 
                   ...
                   "1942,693,405,2038,2235,876,2160,1505,669,2239,1363,551," + 
                   "1369,1860,186,1431,2333,1225,402,376,2165,992,831,2249," + 
                   "65,1406,875,2073,683,527,1421,1917,1630,818,766,748,621," +
                   "1710,39,1173,1202,535,1747,1952,1651,154,770,583,1740," + 
                   "543,338,2296,2340,1035,2215,168,286,88,1857,1135,2241," + 
                   "1018,803,180")
argdict["-test_scenarios"] = "1351,1988,852,2878,1329,965,913,814,653,228"
...
argdict["-pmus"] = ("1127,961,2287,512,1496,1423,470,1804,515,207,1736,1525," + 
                   ...
                   "543,338,2296,2340,1035,2215,168,286,88,1857,1135,2241," + 
                   "1018,803,180")
argdict["-test_scenarios"] = ("86,1 2 3;176,1 2;539,7;702,4 5;754,2 3 4 5;" + 
                              "994,2 3 4 5;1131,2;1513,4 5 6;1663,1 2 3 4;" + 
                              "2164,5")
argdict["-write_file"] = "Polishsubs_sparse35.txt"
argdict["-verbose"] = "True"
args = [NAME] + list(chain(*argdict.iteritems()))
# FLiER_Substation_Test.main(args)
